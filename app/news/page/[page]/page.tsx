...
const PAGE_SIZE = 10;
export async function generateMetadata({ params }: { params: Promise<{ page: string }> }): Promise<Metadata> { const {page} = await params; return pageMetadata(`AI电商出海资讯 · 第${page}页`, "AI Global跨境电商行业资讯分页。", `/news/page/${page}`); }
