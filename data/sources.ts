...
export const articleSources: ArticleSourceConfig[] = [
  { name: "OpenAI News", url: "https://openai.com/news/rss.xml", type: "rss", defaultCategory: "AI产品", categorySlug: "ai-products", enabled: true, official: true },
  ...
  { name: "Product Hunt", url: "https://www.producthunt.com/feed", type: "atom", defaultCategory: "AI产品", categorySlug: "ai-products", enabled: false, official: true },
];
