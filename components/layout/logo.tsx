...
export function Logo({ light = false, compact = false }: { light?: boolean; compact?: boolean }) {
  return <Link href="/" className="group flex items-center gap-3" aria-label="AI Global 首页">
    <span className="relative flex size-9 items-center justify-center rounded-[11px] bg-[var(--brand)] text-sm font-black text-[#052118] shadow-[inset_0_0_0_1px_rgba(255,255,255,.28)]">
      AI<span className="absolute -right-1 -top-1 size-2.5 rounded-full border-2 border-[var(--ocean)] bg-[var(--orange)]" />
    </span>
