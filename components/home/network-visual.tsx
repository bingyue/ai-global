export function NetworkVisual() {
  return <div className="relative mx-auto aspect-square w-full max-w-[590px]" aria-label="AI全球商业网络抽象图">
    ...
    <span className="absolute left-[48%] top-[2%] font-mono text-[9px] tracking-[.18em] text-white/30">GLOBAL / 01</span><span className="absolute bottom-[2%] right-[38%] font-mono text-[9px] tracking-[.18em] text-white/30">INTELLIGENCE / AI</span>
  </div>;
}
